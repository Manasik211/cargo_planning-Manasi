...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        # Make sure node_a1's positive effects are not canceled by node_a2's negative effects
        for effect in node_a1.action.effect_add:
            if effect in node_a2.action.effect_rem:
                return True

        # Make sure node_a2's positive effects are not canceled by node_a1's negative effects
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        # Checking that two state literals don't have opposite polarity
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        # Checking that node_s1's preconditions aren't mutually exclusive with node_s2's preconditions
