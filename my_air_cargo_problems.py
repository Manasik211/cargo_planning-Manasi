...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        # Here, we are createing concrete Action objects based on the domain action schema for:
        #Load, Unload, and Fly
            ...
            for a in self.airports:
                for c in self.cargos:
                    for p in self.planes:
                        precond_positive = [expr("At({}, {})".format(p, a)),
                                       expr("At({}, {})".format(c, a)),
                                       ]
                        precond_negative = []
        ...
        def fly_actions():
            ...
            for fr in self.airports:
                for to in self.airports:
                    if fr != to:
                        for p in self.planes:
                            precond_positive = [expr("At({}, {})".format(p, fr)),
                                           ]
                            precond_negative = []
    ...
    def actions(self, state: str) -> list:
        ...
        # Referred from example_have_cake.py
        possible_actions = []

        # Getting a handle to our knowledge base of logical expressions (propositional logic)
        kb = PropKB()
        ...
        #An action is executable if it satisfies a problem's preconditions and must 
        #appear in a problem's positive preconditions and not be in a problem's negative ones.
    ...
    def result(self, state: str, action: Action):
       ...
       # The precondition defines the states in which the action can be
        ...
        # If they're add effects,fluents are added to the new state's positive sentences. 
        #if they're  remove effects,fluents need to be added to the new state's negative sentences.
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        # Using another version of the goal_test() fn
        count = 0
        for clause in self.goal:
            if clause not in kb.clauses:
                count += 1
